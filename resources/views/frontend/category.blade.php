    ...
    <div class="post post-grid rounded bordered h-100">
        ...
        <div class="details">
            <ul class="meta list-inline mb-0">
                <li class="list-inline-item"><a href="category.html#"><img src="{{ asset('storage/users/'.$post->user->profile) }}"class="author img-fluid rounded-circle" style="width:50px; height:50px;object-fit:cover; object-position: center;" alt="author"/>{{$post->user->name }}</a></li>
                <li class="list-inline-item">{{ \Carbon\Carbon::parse($post->created_at)->format('F-d-Y') }}</li>
            </ul>
            <h5 ><a href="{{ route('showPost',$post->slug) }}">{{ $post->title}}</a></h5>
