                    ...
                    <div class="post post-single">
						...
						<div class="post-header">
							...
							<ul class="meta list-inline mb-0">
								<li class="list-inline-item"><a href="blog-single.html#"><img src="{{ asset('storage/users/'.$post->user->profile) }}"class="author img-fluid rounded-circle" style="width:50px; height:50px;object-fit:cover; object-position: center;" alt="author"/>{{ $post->user->name }}</a></li>
								<li class="list-inline-item"><a href="blog-single.html#">{{ $post->category->name}}</a></li>
...
{!!$post->description!!}
					...
					<div class="about-author padding-30 rounded">
						<div class="thumb">
							<img src="{{ asset('storage/users/'.$post->user->profile) }}"class="author img-fluid rounded-circle" style="width:50px; height:50px;object-fit:cover; object-position: center;"alt="Katen Doe" />
						</div>
						<div class="details">
							<h4 class="name"><a href="blog-single.html#">{{ $post->user->name }}</a></h4>
