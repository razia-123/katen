...
<div class="row  mt-4 mx-auto ">
    <div class="col-lg-12 ">
      <div class="card-style mb-30 ">
        <h3 class="mt-5 text-center"> All Posts</h3>
...
<i class="lni lni-star-{{ $post->is_feature ?'fill':'empty' }}"></i>
            ...
            <td class="min-width">
                ...
                <td>
                  <div >
                    <button >
                        <a href="" class="btn btn-sm btn-warning btn-hover"><i class="fas fa-edit"></i></a>
                        <a href="" class="btn btn-sm btn- btn-success"><i class="fas fa-eye"></i></a>
                        <a href="" class="btn btn-sm btn-danger btn-hover"><i class="fas fa-trash"></i></a>
                    </button>
                  </div>
                </td>
              </tr>
